...
<div class="page-container">
    ...
    <div class="page-header">
        <h1 class="page-title">
            <i class="fas fa-user-times me-2 text-danger"></i>Siswa Nonaktif
        </h1>
        <p class="page-subtitle">Kelola siswa yang sudah tidak aktif</p>
    </div>
    ...
    <div class="stats-bar">
        <div class="stats-info">
            <div class="stat-item">
                ...
                Total Siswa Nonaktif: <span class="stat-number">{{ $siswas->count() }}</span>
            </div>
        </div>
        <div class="action-buttons">
            ...
            <a href="{{ route('admin.siswa-cuti') }}" class="btn-compact btn-warning-compact">
                <i class="fas fa-user-clock me-1"></i>Siswa Cuti
            </a>
        </div>
    </div>
    ...
    <div class="table-container">
            ...
            <table class="table-clean">
                <thead>
                    <tr>
                        ...
                        <th width="80">Kelas Terakhir</th>
                        <th width="90">Tanggal Nonaktif</th>
                        <th width="70">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <td>
                            <div class="action-group">
                                ...
                                <form method="POST" action="{{ route('admin.siswa.destroy', $siswa) }}" class="d-inline">
                                    @csrf @method('DELETE')
                                    <button type="submit" class="btn-icon btn-danger" title="Hapus Permanen"
                                            onclick="return confirm('HAPUS PERMANEN data {{ $siswa->nama }}?')">
        ...
        @else
            <div style="text-align: center; padding: 3rem; color: #6c757d;">
                <i class="fas fa-user-times" style="font-size: 3rem; opacity: 0.3; margin-bottom: 1rem;"></i>
                <h5>Tidak Ada Siswa Nonaktif</h5>
                <p>Belum ada siswa dengan status nonaktif.</p>
                <a href="{{ route('admin.siswa-aktif') }}" class="btn-compact btn-primary-compact">
